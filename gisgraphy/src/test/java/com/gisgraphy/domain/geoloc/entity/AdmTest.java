...
public class AdmTest extends AbstractIntegrationHttpSolrTestCase {
	...
	try {
	    GeolocTestHelper.createAdm("adm", "FR", "A1", "B2", "C3", "D4",
		    null, 5);
