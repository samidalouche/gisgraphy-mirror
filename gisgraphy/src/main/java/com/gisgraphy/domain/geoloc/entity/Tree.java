...
/**
 * Represents a {@link Tree}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Tree extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Tree} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Tree}
     */
    public Tree(GisFeature gisFeature) {
	super(gisFeature);
    }
