...
/**
 * Represents a {@link Stadium}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Stadium extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Stadium} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Stadium}
     */
    public Stadium(GisFeature gisFeature) {
	super(gisFeature);
    }
