...
/**
 * Represents a {@link Ravin}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Ravin extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Ravin} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Ravin}
     */
    public Ravin(GisFeature gisFeature) {
	super(gisFeature);
    }
