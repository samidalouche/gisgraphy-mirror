...
/**
 * Represents a {@link PolicePost}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class PolicePost extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link PolicePost} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link PolicePost}
     */
    public PolicePost(GisFeature gisFeature) {
	super(gisFeature);
    }
