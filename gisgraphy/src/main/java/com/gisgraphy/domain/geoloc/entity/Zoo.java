...
/**
 * Represents a {@link Zoo}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Zoo extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Zoo} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Zoo}
     */
    public Zoo(GisFeature gisFeature) {
	super(gisFeature);
    }
