...
/**
 * Represents a {@link ATM}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class ATM extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link ATM} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link ATM}
     */
    public ATM(GisFeature gisFeature) {
	super(gisFeature);
    }
