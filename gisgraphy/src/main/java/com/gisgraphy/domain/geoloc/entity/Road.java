...
/**
 * Represents a {@link Road}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Road extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Road} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Road}
     */
    public Road(GisFeature gisFeature) {
	super(gisFeature);
    }
