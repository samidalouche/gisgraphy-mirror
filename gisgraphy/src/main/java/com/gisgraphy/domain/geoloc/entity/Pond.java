...
/**
 * Represents a {@link Pond}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Pond extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Pond} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Pond}
     */
    public Pond(GisFeature gisFeature) {
	super(gisFeature);
    }
