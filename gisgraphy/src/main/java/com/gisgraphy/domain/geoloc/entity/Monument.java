...
/**
 * Represents a {@link Monument}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Monument extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Monument} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Monument}
     */
    public Monument(GisFeature gisFeature) {
	super(gisFeature);
    }
