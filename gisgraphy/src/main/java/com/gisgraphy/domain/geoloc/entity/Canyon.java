...
/**
 * Represents a {@link Canyon}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Canyon extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Canyon} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Canyon}
     */
    public Canyon(GisFeature gisFeature) {
	super(gisFeature);
    }
