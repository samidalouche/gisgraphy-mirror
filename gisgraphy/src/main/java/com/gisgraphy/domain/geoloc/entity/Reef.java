...
/**
 * Represents a {@link Reef}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Reef extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Reef} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Reef}
     */
    public Reef(GisFeature gisFeature) {
	super(gisFeature);
    }
