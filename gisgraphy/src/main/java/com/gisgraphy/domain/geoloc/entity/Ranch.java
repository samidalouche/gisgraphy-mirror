...
/**
 * Represents a {@link Ranch}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Ranch extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Ranch} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Ranch}
     */
    public Ranch(GisFeature gisFeature) {
	super(gisFeature);
    }
