...
/**
 * Represents a {@link Religious}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Religious extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Religious} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link Religious}
     */
    public Religious(GisFeature gisFeature) {
	super(gisFeature);
    }
