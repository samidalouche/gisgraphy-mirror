...
/**
 * Represents a {@link Ice}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Ice extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Ice} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Ice}
     */
    public Ice(GisFeature gisFeature) {
	super(gisFeature);
    }
