...
/**
 * Represents a {@link Hill}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Hill extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Hill} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Hill}
     */
    public Hill(GisFeature gisFeature) {
	super(gisFeature);
    }
