...
/**
 * Represents a {@link Farm}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Farm extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Farm} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Farm}
     */
    public Farm(GisFeature gisFeature) {
	super(gisFeature);
    }
