...
/**
 * Represents a {@link Factory}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Factory extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Factory} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Factory}
     */
    public Factory(GisFeature gisFeature) {
	super(gisFeature);
    }
