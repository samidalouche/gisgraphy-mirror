...
/**
 * Represents a {@link Prison}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Prison extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Prison} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Prison}
     */
    public Prison(GisFeature gisFeature) {
	super(gisFeature);
    }
