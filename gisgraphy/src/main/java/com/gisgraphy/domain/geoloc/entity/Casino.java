...
/**
 * Represents a {@link Casino}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Casino extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Casino} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Casino}
     */
    public Casino(GisFeature gisFeature) {
	super(gisFeature);
    }
