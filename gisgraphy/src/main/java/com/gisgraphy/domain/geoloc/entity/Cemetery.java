...
/**
 * Represents a {@link Cemetery}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Cemetery extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Cemetery} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Cemetery}
     */
    public Cemetery(GisFeature gisFeature) {
	super(gisFeature);
    }
