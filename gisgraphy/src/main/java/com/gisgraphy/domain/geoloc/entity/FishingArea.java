...
/**
 * Represents a {@link FishingArea}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class FishingArea extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link FishingArea} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link FishingArea}
     */
    public FishingArea(GisFeature gisFeature) {
	super(gisFeature);
    }
