...
/**
 * Represents a {@link Forest}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Forest extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Forest} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Forest}
     */
    public Forest(GisFeature gisFeature) {
	super(gisFeature);
    }
