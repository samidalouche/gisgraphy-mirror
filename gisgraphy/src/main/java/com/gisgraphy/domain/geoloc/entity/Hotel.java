...
/**
 * Represents a {@link Hotel}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Hotel extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Hotel} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Hotel}
     */
    public Hotel(GisFeature gisFeature) {
	super(gisFeature);
    }
