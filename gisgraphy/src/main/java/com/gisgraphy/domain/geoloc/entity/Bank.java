...
/**
 * Represents a {@link Bank}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Bank extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Bank} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Bank}
     */
    public Bank(GisFeature gisFeature) {
	super(gisFeature);
    }
