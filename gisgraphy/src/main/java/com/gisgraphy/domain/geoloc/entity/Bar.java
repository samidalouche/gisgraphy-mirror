...
/**
 * Represents a {@link Bar}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Bar extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Bar} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Bar}
     */
    public Bar(GisFeature gisFeature) {
	super(gisFeature);
    }
