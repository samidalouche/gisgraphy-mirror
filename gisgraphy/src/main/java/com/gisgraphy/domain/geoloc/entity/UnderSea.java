...
/**
 * Represents a {@link UnderSea}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class UnderSea extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link UnderSea} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link UnderSea}
     */
    public UnderSea(GisFeature gisFeature) {
	super(gisFeature);
    }
