...
/**
 * Represents a {@link Cliff}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Cliff extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Cliff} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Cliff}
     */
    public Cliff(GisFeature gisFeature) {
	super(gisFeature);
    }
