...
/**
 * Represents a {@link Aqueduc}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Aqueduc extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Aqueduc} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Aqueduc}
     */
    public Aqueduc(GisFeature gisFeature) {
	super(gisFeature);
    }
