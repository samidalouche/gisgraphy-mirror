...
/**
 * Represents a {@link Parking}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Parking extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Parking} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Parking}
     */
    public Parking(GisFeature gisFeature) {
	super(gisFeature);
    }
