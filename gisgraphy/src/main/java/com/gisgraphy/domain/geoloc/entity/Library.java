...
/**
 * Represents a {@link Library}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Library extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Library} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Library}
     */
    public Library(GisFeature gisFeature) {
	super(gisFeature);
    }
