...
/**
 * Represents a {@link Castle}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Castle extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Castle} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Castle}
     */
    public Castle(GisFeature gisFeature) {
	super(gisFeature);
    }
