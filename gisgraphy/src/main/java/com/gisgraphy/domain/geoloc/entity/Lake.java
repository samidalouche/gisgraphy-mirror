...
/**
 * Represents a {@link Lake}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Lake extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Lake} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Lake}
     */
    public Lake(GisFeature gisFeature) {
	super(gisFeature);
    }
