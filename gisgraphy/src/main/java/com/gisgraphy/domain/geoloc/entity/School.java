...
/**
 * Represents a {@link School}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class School extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link School} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link School}
     */
    public School(GisFeature gisFeature) {
	super(gisFeature);
    }
