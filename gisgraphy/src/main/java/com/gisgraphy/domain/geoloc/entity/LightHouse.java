...
/**
 * Represents a {@link LightHouse}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class LightHouse extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link LightHouse} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link LightHouse}
     */
    public LightHouse(GisFeature gisFeature) {
	super(gisFeature);
    }
