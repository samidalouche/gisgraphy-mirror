...
/**
 * Represents a {@link Mall}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Mall extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Mall} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Mall}
     */
    public Mall(GisFeature gisFeature) {
	super(gisFeature);
    }
