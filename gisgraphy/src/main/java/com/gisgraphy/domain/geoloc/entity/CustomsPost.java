...
/**
 * Represents a {@link CustomsPost}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class CustomsPost extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link CustomsPost} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link CustomsPost}
     */
    public CustomsPost(GisFeature gisFeature) {
	super(gisFeature);
    }
