...
/**
 * Represents a {@link Strait}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Strait extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Strait} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Strait}
     */
    public Strait(GisFeature gisFeature) {
	super(gisFeature);
    }
