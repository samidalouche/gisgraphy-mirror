...
/**
 * Represents a {@link Hospital}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Hospital extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Hospital} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Hospital}
     */
    public Hospital(GisFeature gisFeature) {
	super(gisFeature);
    }
