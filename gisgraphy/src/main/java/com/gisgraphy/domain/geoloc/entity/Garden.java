...
/**
 * Represents a {@link Garden}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Garden extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Garden} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Garden}
     */
    public Garden(GisFeature gisFeature) {
	super(gisFeature);
    }
