...
/**
 * Represents a {@link Rail}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Rail extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Rail} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Rail}
     */
    public Rail(GisFeature gisFeature) {
	super(gisFeature);
    }
