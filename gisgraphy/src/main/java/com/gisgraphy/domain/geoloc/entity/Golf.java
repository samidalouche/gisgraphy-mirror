...
/**
 * Represents a {@link Golf}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Golf extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Golf} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Golf}
     */
    public Golf(GisFeature gisFeature) {
	super(gisFeature);
    }
