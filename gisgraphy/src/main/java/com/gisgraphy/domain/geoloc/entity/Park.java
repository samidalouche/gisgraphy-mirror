...
/**
 * Represents a {@link Park}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Park extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Park} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Park}
     */
    public Park(GisFeature gisFeature) {
	super(gisFeature);
    }
