...
/**
 * Represents a {@link Gulf}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Gulf extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Gulf} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Gulf}
     */
    public Gulf(GisFeature gisFeature) {
	super(gisFeature);
    }
