...
/**
 * Represents a {@link Sea}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Sea extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Sea} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Sea}
     */
    public Sea(GisFeature gisFeature) {
	super(gisFeature);
    }
