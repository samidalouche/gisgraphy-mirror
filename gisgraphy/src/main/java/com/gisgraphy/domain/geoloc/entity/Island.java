...
/**
 * Represents a {@link Island}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Island extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Island} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Island}
     */
    public Island(GisFeature gisFeature) {
	super(gisFeature);
    }
