...
/**
 * Represents a {@link Gorge}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Gorge extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Gorge} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Gorge}
     */
    public Gorge(GisFeature gisFeature) {
	super(gisFeature);
    }
