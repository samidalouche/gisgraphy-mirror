...
/**
 * Represents a {@link Tower}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Tower extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Tower} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Tower}
     */
    public Tower(GisFeature gisFeature) {
	super(gisFeature);
    }
