...
/**
 * Represents a {@link Falls}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Falls extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Falls} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Falls}
     */
    public Falls(GisFeature gisFeature) {
	super(gisFeature);
    }
