...
/**
 * Represents a {@link Museum}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Museum extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Museum} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Museum}
     */
    public Museum(GisFeature gisFeature) {
	super(gisFeature);
    }
