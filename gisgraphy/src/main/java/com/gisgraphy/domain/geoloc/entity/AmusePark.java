...
/**
 * Represents a {@link AmusePark}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class AmusePark extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link AmusePark} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link AmusePark}
     */
    public AmusePark(GisFeature gisFeature) {
	super(gisFeature);
    }
