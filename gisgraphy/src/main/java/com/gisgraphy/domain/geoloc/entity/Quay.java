...
/**
 * Represents a {@link Quay}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Quay extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Quay} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Quay}
     */
    public Quay(GisFeature gisFeature) {
	super(gisFeature);
    }
