...
/**
 * Represents a {@link Mountain}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Mountain extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Mountain} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Mountain}
     */
    public Mountain(GisFeature gisFeature) {
	super(gisFeature);
    }
