...
/**
 * Represents a {@link GrassLand}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class GrassLand extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link GrassLand} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link GrassLand}
     */
    public GrassLand(GisFeature gisFeature) {
	super(gisFeature);
    }
