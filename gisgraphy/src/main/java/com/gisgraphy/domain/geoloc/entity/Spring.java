...
/**
 * Represents a {@link Spring}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Spring extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Spring} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Spring}
     */
    public Spring(GisFeature gisFeature) {
	super(gisFeature);
    }
