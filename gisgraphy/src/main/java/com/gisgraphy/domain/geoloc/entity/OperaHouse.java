...
/**
 * Represents a {@link OperaHouse}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class OperaHouse extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link OperaHouse} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link OperaHouse}
     */
    public OperaHouse(GisFeature gisFeature) {
	super(gisFeature);
    }
