...
/**
 * Represents a {@link Continent}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Continent extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Continent} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link Continent}
     */
    public Continent(GisFeature gisFeature) {
	super(gisFeature);
    }
