...
/**
 * Represents a {@link WaterBody}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class WaterBody extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link WaterBody} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link WaterBody}
     */
    public WaterBody(GisFeature gisFeature) {
	super(gisFeature);
    }
