...
/**
 * Represents a {@link Mill}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Mill extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Mill} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Mill}
     */
    public Mill(GisFeature gisFeature) {
	super(gisFeature);
    }
