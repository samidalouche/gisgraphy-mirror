...
/**
 * Represents a {@link Cirque}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Cirque extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Cirque} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Cirque}
     */
    public Cirque(GisFeature gisFeature) {
	super(gisFeature);
    }
