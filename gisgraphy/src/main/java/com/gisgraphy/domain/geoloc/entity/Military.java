...
/**
 * Represents a {@link Military}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Military extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Military} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Military}
     */
    public Military(GisFeature gisFeature) {
	super(gisFeature);
    }
