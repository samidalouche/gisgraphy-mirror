...
/**
 * Represents a {@link Ocean}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Ocean extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Ocean} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Ocean}
     */
    public Ocean(GisFeature gisFeature) {
	super(gisFeature);
    }
