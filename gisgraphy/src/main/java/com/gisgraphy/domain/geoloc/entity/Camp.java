...
/**
 * Represents a {@link Camp}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Camp extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Camp} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Camp}
     */
    public Camp(GisFeature gisFeature) {
	super(gisFeature);
    }
