...
/**
 * Represents a {@link Mole}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Mole extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Mole} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Mole}
     */
    public Mole(GisFeature gisFeature) {
	super(gisFeature);
    }
