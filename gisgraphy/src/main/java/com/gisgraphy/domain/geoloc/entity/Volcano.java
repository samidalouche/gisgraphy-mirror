...
/**
 * Represents a {@link Volcano}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Volcano extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Volcano} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Volcano}
     */
    public Volcano(GisFeature gisFeature) {
	super(gisFeature);
    }
