...
/**
 * Represents a {@link Plantation}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Plantation extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Plantation} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link Plantation}
     */
    public Plantation(GisFeature gisFeature) {
	super(gisFeature);
    }
