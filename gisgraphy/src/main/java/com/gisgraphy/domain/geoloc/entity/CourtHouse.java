...
/**
 * Represents a {@link CourtHouse}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class CourtHouse extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link CourtHouse} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link CourtHouse}
     */
    public CourtHouse(GisFeature gisFeature) {
	super(gisFeature);
    }
