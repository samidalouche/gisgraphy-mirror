...
/**
 * Represents a {@link Dam}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Dam extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Dam} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Dam}
     */
    public Dam(GisFeature gisFeature) {
	super(gisFeature);
    }
