...
/**
 * Represents a {@link Oasis}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Oasis extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Oasis} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Oasis}
     */
    public Oasis(GisFeature gisFeature) {
	super(gisFeature);
    }
