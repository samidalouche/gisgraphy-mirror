...
/**
 * Represents a {@link Beach}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Beach extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Beach} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Beach}
     */
    public Beach(GisFeature gisFeature) {
	super(gisFeature);
    }
