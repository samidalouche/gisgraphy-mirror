...
<fmt:message key="gisgraphy.baduse"><fmt:param>http://www.gisgraphy.com/abuse.txt</fmt:param></fmt:message>.
	        ...
	        <div id="footer" class="clearfix">
             <div class="divider"><div></div></div>
    <span class="left"><fmt:message key="webapp.version"/> | <a href="http://www.gisgraphy.com/feedback/" ><span class="underline red">We love feedback</span></a> | <span id="validators">
